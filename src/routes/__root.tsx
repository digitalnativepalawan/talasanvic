...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "TALA AI Agent" },
      { name: "description", content: "Your San Vicente Island Assistant." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "TALA AI Agent" },
      { property: "og:description", content: "Your San Vicente Island Assistant." },
