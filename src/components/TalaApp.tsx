...
const MOCK_BUSINESSES: Record<QuickActionKey, BusinessCard[]> = {
  island: [
    {
      id: "biz-lakawon",
      name: "Lakawon & the Seven Islands",
      tag: "Boat Tour · Group Charter",
      rating: 4.9,
      reviewCount: 212,
      ...
      open: "Departs 9:00 AM",
      category: "tour",
      description:
        "Traditional outrigger visiting 7 islands — snorkel, cliff-jump, and a beach lunch on a sandbar.",
    },
    {
      id: "biz-port-barton",
      name: "Port Barton Island Hop",
      tag: "Small Group · Max 6 pax",
      rating: 4.8,
      reviewCount: 147,
      ...
      open: "Departs 8:30 AM",
      category: "tour",
      description: "A quieter route north with hidden lagoons and fewer boats.",
    },
  ],
  food: [
    {
      id: "biz-kuya-boy",
      name: "Kuya Boy's Seafood Grill",
      tag: "Local Seafood · Beachfront",
      rating: 4.8,
      reviewCount: 533,
      distance: "800 m · 3 min walk",
      price: "₱380 avg meal",
      image:
        "https://images.unsplash.com/photo-1559339352-11d035aa65de?auto=format&fit=crop&w=900&q=70",
      open: "Open now · until 11 PM",
      category: "food",
      description: "Fresh tuna. Cold coconut. Sunset tables.",
    },
    {
      id: "biz-sunrise",
      name: "Sunrise Café & Bakery",
      tag: "Breakfast · Sourdough",
      rating: 4.7,
      reviewCount: 201,
      ...
      open: "Open now · 6 AM – 3 PM",
      category: "food",
      description: "Warm sourdough. Mango butter. Slow mornings.",
    },
  ],
  sunset: [
    {
      id: "biz-cape",
      name: "Cape San Vicente Sunset Cliff",
      tag: "Viewpoint · No entrance fee",
      rating: 4.9,
      reviewCount: 318,
      ...
      image:
        "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=70",
      open: "Golden hour 5:48 PM",
      category: "beach",
      description: "A 15-minute hike up. Locals gather with guitars and coconut wine.",
    },
  ],
  transport: [
    {
      id: "biz-jeep",
      name: "North Line Jeepney Schedule",
      tag: "Public Transport · Daily",
      rating: 4.3,
      reviewCount: 88,
      distance: "Departs town plaza",
      price: "₱45 / trip",
      image:
        "https://images.unsplash.com/photo-1581092334651-ddf26d9a09d0?auto=format&fit=crop&w=900&q=70",
      open: "Next: 10:30 AM",
      category: "transport",
      description: "Runs hourly between San Vicente and Port Barton. Cash only.",
    },
  ],
  travelers: [
    {
      id: "biz-group-hop",
      name: "Island Hop Meet-up · Tomorrow",
      tag: "4 travelers · 2 spots open",
      rating: 4.9,
      reviewCount: 42,
      distance: "Meet at Port Barton pier",
      price: "₱1,450 / seat",
      image:
        "https://images.unsplash.com/photo-1544551763-46a013bb70d5?auto=format&fit=crop&w=900&q=70",
      open: "Departs 9:00 AM",
      category: "event",
      description: "Two from Germany, one from Seoul, a photographer from Cebu. Friendly vibe.",
    },
  ],
  stay: [
    {
      id: "biz-palms",
      name: "The Palms Alimanguan",
      tag: "Boutique Resort · Beachfront",
      rating: 4.8,
      reviewCount: 264,
      distance: "Your current stay",
      price: "₱4,800 / night",
      image:
        "https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&w=900&q=70",
      open: "Check-in 2 PM",
      category: "stay",
      description: "Low-key luxury, outdoor bath, on-site restaurant.",
    },
  ],
  tonight: [
    {
      id: "biz-bonfire",
      name: "Full Moon Bonfire at Long Beach",
      ...
      open: "Starts 7:30 PM",
      category: "event",
      description: "Acoustic sets, fire dancers, bring-your-own-bottle. Meet at the north tower.",
    },
  ],
  scooter: [
    {
      id: "biz-honda",
      name: "Kuya Jun's Scooter Rental",
      tag: "Honda Click 125i · Full tank",
      rating: 4.6,
      reviewCount: 189,
      distance: "500 m · 2 min walk",
      price: "₱500 / day",
      image:
        "https://images.unsplash.com/photo-1558981806-ec527fa84c39?auto=format&fit=crop&w=900&q=70",
      open: "Open now · 7 AM – 8 PM",
      category: "transport",
      description: "Deposit: one ID + ₱1,000. Includes helmets. Free pickup from your resort.",
    },
  ],
};
  ...
  sunset: [
    {
      ...
      name: "Cape San Vicente Sunset Cliff",
      distance: "3.2 km · 12 min drive",
      meta: "Quiet · Ocean view · Free access",
      category: "viewpoint",
    },
  ],
  island: [
    {
      id: "pin-port",
      name: "Port Barton Pier — Meeting Point",
      distance: "18 km · 25 min drive",
      meta: "Parking available · Boat departs 9 AM",
      category: "town",
    },
  ],
  food: [
    {
      id: "pin-kuya",
      name: "Kuya Boy's — Beachfront",
      distance: "800 m · 3 min walk",
      meta: "Open-air · Family-run · Popular",
      category: "town",
    },
  ],
};
...
const SUGGESTION_RESPONSES: Record<
  string,
  { text: string; cards?: BusinessCard[]; location?: LocationPin }
> = {
  "Who wants to go island hopping tomorrow?": {
  ...
  "Quiet beach recommendations": {
    ...
    location: {
      id: "pin-alimanguan",
      name: "Alimanguan Quiet Beach",
      distance: "2.1 km · 6 min drive",
      meta: "Quiet · Shallow water · Palms shade",
      category: "beach",
    },
  },
  "Find me other travelers": {
...
const TALA_SUGGESTIONS: {
  emoji: string;
  title: string;
  subtitle: string;
  query: string | null;
  key: QuickActionKey | null;
  soon?: boolean;
}[] = [
  {
    emoji: "🌅",
    title: "Best Sunset Tonight",
    subtitle: "8 travelers interested",
    query: "Where should I watch the sunset tonight?",
    key: "sunset",
  },
  {
    emoji: "🏝",
    title: "Island Hop Tomorrow",
    subtitle: "Boat leaves 8:30 AM",
    query: "Who wants to go island hopping tomorrow?",
    key: "island",
  },
  {
    emoji: "🍤",
    title: "Seafood Nearby",
    subtitle: "4 minute ride",
    query: "Best seafood nearby?",
    key: "food",
  },
  {
    emoji: "👥",
    title: "Meet Travelers",
    subtitle: "12 currently online",
    query: "Find me other travelers",
    key: "travelers",
  },
  {
    emoji: "🛵",
    title: "El Nido Luxury Shuttle",
...
const INITIAL_MESSAGES: Message[] = [
  {
    ...
    role: "tala",
    kind: "text",
    text: "Good morning, Marco. I see you're staying at The Palms in Alimanguan. Three beautiful days ahead — low tide at 8:30 AM. How can I help?",
    time: "9:02 AM",
  },
  {
    id: "m2",
    role: "user",
    kind: "text",
    text: "I want to go island hopping tomorrow with a few people. Any groups forming?",
    time: "9:03 AM",
  },
  {
    id: "m3",
  ...
  },
  {
    ...
    role: "tala",
    kind: "business",
    business: MOCK_BUSINESSES.travelers[0],
    time: "9:03 AM",
  },
  {
    id: "m5",
    role: "user",
    kind: "text",
    text: "Perfect. And where should we watch the sunset tonight?",
    time: "9:04 AM",
  },
  {
    id: "m6",
    role: "tala",
    kind: "text",
    text: "The cliff at Cape San Vicente is clearing up beautifully — golden hour at 5:48 PM. There's a small gathering of travelers bringing guitars and coconut wine. Want a pin?",
    time: "9:04 AM",
  },
  {
    id: "m7",
    role: "tala",
    kind: "location",
    location: MOCK_LOCATIONS.sunset?.[0],
    time: "9:04 AM",
  },
  { id: "m8", role: "user", kind: "text", text: "Seafood dinner nearby after?", time: "9:05 AM" },
  {
    ...
    role: "tala",
    kind: "text",
    text: "Three places the locals love this week. Kuya Boy's has the freshest grilled tuna tail tonight — they just unloaded from the morning catch.",
    time: "9:05 AM",
  },
...
function VoiceOrb({ state, onClick }: { state: VoiceState; onClick: () => void }) {
  ...
  return (
    <button
      onClick={onClick}
      className="relative flex h-60 w-60 items-center justify-center outline-none"
      aria-label={`TALA voice orb, ${state}`}
    >
      ...
      <span
        className={`absolute inset-2 rounded-full bg-[#D7CAAB]/25 ${active ? "ring-pulse" : ""}`}
      />
      <span
        className={`absolute inset-6 rounded-full bg-[#EFE4D0]/40 ${active ? "ring-pulse-2" : ""}`}
      />
      {/* glass halo */}
      ...
      <div
        ...
        style={{
          background: coreBg,
          boxShadow:
            "inset 0 3px 12px rgba(255,255,255,0.75), inset 0 -16px 34px rgba(120,90,60,0.16), 0 28px 70px -22px rgba(60,45,30,0.40)",
        }}
      >
        ...
        <div className="relative flex h-[88px] w-[88px] items-center justify-center rounded-full bg-[#FFFDF8]/90 shadow-inner backdrop-blur-sm">
          {state === "idle" ? (
            <Mic className="h-7 w-7 text-[#BFA984]" />
          ) : (
            <div className="font-serif-display text-[42px] leading-none text-[#2A2420]">T</div>
          )}
        </div>
      </div>
    </button>
...
function Waveform({ state, onClick }: { state: VoiceState; onClick: () => void }) {
  const bars =
    state === "speaking" ? 13 : state === "listening" ? 11 : state === "thinking" ? 7 : 5;
  const heights =
    state === "idle"
      ? [4, 4, 4, 4, 4]
      : Array.from({ length: bars }, (_, i) => 8 + ((i * 37) % 22));
  return (
    <button
      onClick={onClick}
      className="flex h-8 w-full items-end justify-center gap-[3px]"
    ...
    <div className="flex flex-col items-center gap-1">
      <div className="flex items-center gap-2">
        <span className="relative flex h-2 w-2">
          {state !== "idle" && (
            <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-[#BA6A43] opacity-60" />
          )}
          <span
            className={`relative inline-flex h-2 w-2 rounded-full ${state === "idle" ? "bg-[#8A7E6E]" : "bg-[#BA6A43]"}`}
          />
        </span>
  ...
  return (
    <div className="overflow-hidden rounded-[24px] bg-[#FFFDF8] shadow-card">
      ...
      <div className="relative h-52 w-full overflow-hidden">
        ...
        <button
          onClick={() => onFavorite(biz.id)}
          className="absolute right-3 top-3 flex h-9 w-9 items-center justify-center rounded-full bg-white/85 text-[#2A2420] shadow-soft backdrop-blur-sm"
        >
          <Heart className={`h-4 w-4 ${favorite ? "fill-[#BA6A43] text-[#BA6A43]" : ""}`} />
        </button>
        <div className="absolute bottom-4 left-4 right-4">
          <div className="font-serif-display text-[22px] leading-tight text-[#FFFDF8] drop-shadow-sm">
            {biz.name}
          </div>
      ...
      <div className="space-y-3 p-4">
        {biz.description && (
          <p className="font-serif-display text-[17px] leading-snug text-[#2A2420]">
            {biz.description}
          </p>
        )}
          ...
          >
            {confirmed ? (
              <span className="inline-flex items-center gap-1.5">
                <Check className="h-3.5 w-3.5" /> Confirmed · {reservation?.time}
              </span>
            ) : (
              "Reserve"
            )}
          </button>
          <button className="flex h-10 w-10 items-center justify-center rounded-full bg-[#F2ECDF] text-[#5A4F44]">
  ...
  return (
    <div className="overflow-hidden rounded-[24px] bg-[#FFFDF8] shadow-soft">
      <div className="map-bg relative h-28 w-full">
        ...
        >
          <path
            d="M0 110 Q 80 60 160 90 T 400 70"
            stroke="#6B8068"
            strokeWidth="1.5"
            fill="none"
            opacity="0.55"
          />
          <path
            d="M0 130 Q 100 100 200 120 T 400 110"
            stroke="#BA6A43"
            strokeWidth="1"
            fill="none"
            opacity="0.4"
      ...
      <div className="space-y-1 p-4">
        ...
        <div className="flex items-center justify-between pt-2 text-[12px]">
          ...
          <button className="flex items-center gap-1 font-medium text-[#435947]">
            Open in map <ChevronRight className="h-3.5 w-3.5" />
          </button>
        </div>
      </div>
    </div>
...
function MessageBubble({
  ...
  return (
    <div
      className={`fade-up flex w-full flex-col gap-1.5 ${isSystem ? "items-center" : isTala ? "items-start" : "items-end"}`}
    >
      {isSystem ? (
        <div className="my-1 flex items-center gap-2 text-[10.5px] uppercase tracking-[0.2em] text-[#8A7E6E]">
          <span className="h-px w-8 bg-[#D7CAAB]" />
          {m.text}
          <span className="h-px w-8 bg-[#D7CAAB]" />
        </div>
      ) : (
        <div className="max-w-[88%]">
          {m.kind === "text" && (
            <div
              className={`rounded-[22px] px-4 py-3 text-[14.5px] leading-relaxed shadow-soft ${isTala ? "rounded-tl-md bg-[#FAF5EB] text-[#2A2420]" : "rounded-tr-md bg-[#D7CAAB] text-[#2A2420]"}`}
            >
              {m.text}
            </div>
          )}
          {m.kind === "image" && m.image && (
            <div className="overflow-hidden rounded-[22px] shadow-soft">
              <img src={m.image} alt="upload" className="h-48 w-full object-cover" />
            </div>
          )}
          {m.kind === "business" && m.business && (
            <BusinessCardView
              ...
              favorite={favorites.has(m.business.id)}
              reservation={reservations[m.business.id]}
            />
          )}
          {m.kind === "location" && m.location && <LocationCardView l={m.location} />}
          <div
            className={`mt-1 flex items-center gap-1.5 text-[11px] text-[#8A7E6E] ${isTala ? "justify-start pl-1" : "justify-end pr-1"}`}
          >
            {isTala && <Volume2 className="h-3 w-3" />}
            <span>{m.time}</span>
            {isTala && <span>· TALA</span>}
          </div>
        </div>
      )}
    </div>
  ...
  return (
    <div className="fade-up fixed inset-0 z-50 flex items-end justify-center bg-[#2A2420]/40 backdrop-blur-sm sm:items-center">
      <div className="w-full max-w-[430px] rounded-t-[32px] bg-[#FAF5EB] p-5 pb-7 shadow-luxe sm:rounded-[32px]">
        ...
        <div className="mb-3 rounded-[22px] border hairline bg-white p-4 shadow-soft">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full border hairline text-[#2A2420]"
            >
              <Minus className="h-4 w-4" />
            </button>
            <div className="flex-1 text-center font-serif-display text-[22px] text-[#2A2420]">
              {party}
            </div>
            <button
        ...
        <div className="mb-3 rounded-[22px] border hairline bg-white p-4 shadow-soft">
          <div className="mb-2 flex items-center gap-1.5 text-[12px] text-[#8A7E6E]">
            <Clock className="h-3.5 w-3.5" /> Time · Tonight
          </div>
          <div className="flex flex-wrap gap-2">
            {times.map((t) => (
              <button
                key={t}
                onClick={() => setTime(t)}
                className={`rounded-full px-3 py-1.5 text-[12px] ${time === t ? "bg-[#2A2420] text-[#FAF5EB]" : "border hairline bg-[#F2ECDF] text-[#2A2420]"}`}
              >
                {t}
              </button>
            ))}
        ...
        <div className="mb-3 space-y-2 rounded-[22px] border hairline bg-white p-4 shadow-soft">
          <div className="flex items-center gap-2">
            <User className="h-3.5 w-3.5 text-[#8A7E6E]" />
            <input
              value={name}
          ...
          <div className="flex items-center gap-2">
            <Phone className="h-3.5 w-3.5 text-[#8A7E6E]" />
            <input
              value={contact}
          ...
          <div className="flex items-center gap-2">
            <BookOpen className="h-3.5 w-3.5 text-[#8A7E6E]" />
            <input
              value={notes}
        ...
        <button
          onClick={confirm}
          className="flex w-full items-center justify-center gap-2 rounded-full bg-[#2A2420] py-3.5 text-[14px] font-medium text-[#FAF5EB] shadow-card"
        >
          <Check className="h-4 w-4" />
          Confirm reservation · {time}
        </button>
        <div className="mt-2 text-center text-[11px] text-[#8A7E6E]">
          You can cancel anytime from your Profile tab.
        </div>
      </div>
    </div>
  );
...
function TabPanel({
  ...
  favorites: Set<string>;
  favoriteBusinesses: BusinessCard[];
}) {
  const titleMap = {
    map: "Island Map",
    community: "Community",
  ...
  const headingMap = {
    map: "Every pin, every path.",
    community: "Meet the island today.",
    experiences: "Curated by locals.",
    profile: "Welcome back, Marco.",
    tala: "",
  };
  return (
    <div className="fade-up flex flex-col">
      <div className="flex items-center justify-between px-5 pt-2 pb-3">
        <div>
          <div className="text-[10.5px] uppercase tracking-[0.22em] text-[#8A7E6E]">
            {titleMap[tab]}
          </div>
          <div className="font-serif-display text-[26px] leading-tight text-[#2A2420]">
            {headingMap[tab]}
          </div>
        </div>
        <button
          onClick={onClose}
          className="flex h-9 w-9 items-center justify-center rounded-full border hairline bg-white text-[#5A4F44] shadow-soft"
        >
          <X className="h-4 w-4" />
        </button>
      </div>
        ...
        {tab === "map" && (
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2.5">
              {["Beaches", "Food", "Sunset", "Transport", "Stay", "Events"].map((c) => (
                <div
                  key={c}
                  className="rounded-[20px] border hairline bg-white p-3 text-[13px] text-[#2A2420] shadow-soft"
                >
                  {c}
                </div>
              ))}
            ...
            {[
              {
                name: "Lina & Kai",
                from: "Seoul, KR",
                doing: "Island hop tomorrow",
                img: "https://images.unsplash.com/photo-1544005313-94ddf0286df2?auto=format&fit=crop&w=400&q=70",
              },
              {
                name: "Tobias",
                from: "Berlin, DE",
                doing: "Looking for scooter buddy",
                img: "https://images.unsplash.com/photo-1531123897727-8f129e1688ce?auto=format&fit=crop&w=400&q=70",
              },
              {
                name: "Aya & Kenji",
                from: "Cebu, PH",
                doing: "Bonfire tonight",
                img: "https://images.unsplash.com/photo-1502767089025-6572583495b4?auto=format&fit=crop&w=400&q=70",
              },
            ].map((p, i) => (
              <div
                key={i}
                className="flex items-center gap-3 rounded-[22px] border hairline bg-white p-3 shadow-soft"
              >
                <img src={p.img} className="h-12 w-12 rounded-full object-cover" alt={p.name} />
                <div className="flex-1">
                  <div className="text-[14px] font-medium text-[#2A2420]">{p.name}</div>
                  <div className="text-[11.5px] text-[#8A7E6E]">
                    {p.from} · {p.doing}
                  </div>
                </div>
                <button className="flex items-center gap-1 rounded-full bg-[#F2ECDF] px-3 py-1.5 text-[12px] text-[#2A2420]">
                  <UserPlus className="h-3.5 w-3.5" /> Say hi
                </button>
              </div>
            ))}
          </div>
        ...
        {tab === "experiences" && (
          <div className="space-y-3">
            {MOCK_BUSINESSES.island.concat(MOCK_BUSINESSES.tonight).map((e) => (
              <div
                key={e.id}
                className="overflow-hidden rounded-[22px] border hairline bg-white shadow-soft"
              >
                <img src={e.image} className="h-32 w-full object-cover" alt={e.name} />
                <div className="p-3">
                  <div className="font-serif-display text-[17px] text-[#2A2420]">{e.name}</div>
                  <div className="text-[12px] text-[#8A7E6E]">
                    {e.tag} · {e.price}
                  </div>
                </div>
              </div>
        ...
        {tab === "profile" && (
          <div className="space-y-3">
            <div className="flex items-center gap-3 rounded-[22px] border hairline bg-white p-4 shadow-soft">
              <div className="flex h-14 w-14 items-center justify-center rounded-full bg-[#F2ECDF] font-serif-display text-[24px] text-[#2A2420]">
                MR
              </div>
              <div className="flex-1">
                <div className="font-serif-display text-[20px] text-[#2A2420]">Marco Reyes</div>
                <div className="text-[12px] text-[#8A7E6E]">Manila · Member since 2024</div>
              </div>
              <Heart className="h-5 w-5 text-[#BA6A43]" />
            </div>
            <div className="rounded-[22px] border hairline bg-white p-4 shadow-soft">
              <div className="mb-2 text-[11px] uppercase tracking-[0.2em] text-[#8A7E6E]">
                Upcoming ({reservations.length})
              </div>
              {reservations.length === 0 ? (
                <div className="text-[13px] text-[#8A7E6E]">
                  No reservations yet. Try Kuya Boy's tonight.
                </div>
              ) : (
                reservations.map((r) => (
                  <div
                    key={r.id}
                    className="flex items-center justify-between border-t hairline py-2 first:border-none"
                  >
                    <div>
                      <div className="text-[13.5px] text-[#2A2420]">{r.businessName}</div>
                      <div className="text-[11.5px] text-[#8A7E6E]">
                        {r.time} · {r.partySize} guests
                      </div>
                    </div>
                    <span className="rounded-full bg-[#435947]/10 px-2 py-1 text-[11px] font-medium text-[#435947]">
                      Confirmed
                    </span>
                  </div>
                ))
            ...
            <div className="rounded-[22px] border hairline bg-white p-4 shadow-soft">
              ...
              {favoriteBusinesses.length === 0 ? (
                <div className="text-[13px] text-[#8A7E6E]">Heart any card to save it here.</div>
              ) : (
                favoriteBusinesses.map((b) => (
                  ...
                  >
                    <div>
                      <div className="text-[13.5px] text-[#2A2420]">{b.name}</div>
                      <div className="text-[11.5px] text-[#8A7E6E]">{b.tag}</div>
                    </div>
                    <Star className="h-4 w-4 fill-[#BA6A43] text-[#BA6A43]" />
                  </div>
                ))
              )}
            </div>
...
export default function App() {
  ...
  const reservationByBiz = useMemo(() => {
    ...
    reservations.forEach((r) => {
      if (r.status === "confirmed") map[r.businessId] = r;
    });
    return map;
  }, [reservations]);
  ...
  const appendMessage = useCallback(
    (m: Omit<Message, "id" | "time"> & { time?: string }) => {
  ...
  useEffect(() => {
    if (voiceError) setToast(voiceError);
  }, [voiceError]);

  const appendUserText = useCallback(
    (text: string) => appendMessage({ role: "user", kind: "text", text }),
    [appendMessage],
  );
  ...
  const runQuery = useCallback(
    (
      userText: string,
      key: QuickActionKey | null,
      custom?: { text?: string; cards?: BusinessCard[]; location?: LocationPin },
    ) => {
      setIsTyping(true);
      ...
      setTimeout(() => {
        ...
        const intro =
          custom?.text ??
          `Here's the best match I found for "${userText}". Locals love it this week —`;
        appendMessage({ role: "tala", kind: "text", text: intro });
        if (custom?.cards && custom.cards.length > 0) {
          custom.cards.forEach((b) =>
            appendMessage({ role: "tala", kind: "business", business: b }),
          );
        } else if (key) {
          (MOCK_BUSINESSES[key] ?? [])
            .slice(0, 2)
            .forEach((b) => appendMessage({ role: "tala", kind: "business", business: b }));
        }
        if (custom?.location)
          appendMessage({ role: "tala", kind: "location", location: custom.location });
        else if (key && MOCK_LOCATIONS[key]) {
          (MOCK_LOCATIONS[key] ?? [])
            .slice(0, 1)
            .forEach((l) => appendMessage({ role: "tala", kind: "location", location: l }));
        }
      }, latency);
    },
    [appendMessage],
    ...
    (prompt: string) => {
      ...
      setTimeout(() => {
        ...
        if (response) {
          ...
          (response.cards ?? []).forEach((b) =>
            appendMessage({ role: "tala", kind: "business", business: b }),
          );
          if (response.location)
            appendMessage({ role: "tala", kind: "location", location: response.location });
        } else {
          runQuery(prompt, null, {
            text: "Great question. Here's what I'd recommend based on what's open right now.",
          });
        }
      }, 700);
    },
  ...
  const openReserve = (b: BusinessCard) => {
    if (reservationByBiz[b.id]) {
      setToast(`Already confirmed at ${b.name}`);
      return;
    }
    setReserveTarget(b);
  };
  const confirmReservation = (r: Reservation) => {
    ...
    appendMessage({
      role: "tala",
      kind: "text",
      text: `All set. Table for ${r.partySize} at ${r.businessName}, ${r.time} tonight. I've sent a pin to your SMS — see you there!`,
    });
  };
  ...
  return (
    <div className="min-h-screen w-full bg-[#EFE6D6] py-6">
      <div
        className="mx-auto flex max-w-[430px] flex-col overflow-hidden rounded-[44px] bg-[#FAF5EB] shadow-luxe"
        style={{ minHeight: 932 }}
      >
        {/* Status bar */}
        <div className="flex items-center justify-between px-6 pt-4 pb-1 text-[12px] font-medium text-[#2A2420]">
          ...
          <div className="flex items-center gap-1.5 text-[#2A2420]">
            ...
            <svg width="16" height="10" viewBox="0 0 16 10" fill="none">
              <path
                d="M1 5 L4 2 L7 5 L10 2 L13 5 L15 3"
                stroke="currentColor"
                strokeWidth="1.3"
                strokeLinecap="round"
        ...
        <header className="flex items-center justify-between px-5 pt-3 pb-4">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#F2ECDF] shadow-soft">
              <Sun className="h-4 w-4 text-[#BA6A43]" />
            </div>
            <div className="leading-tight">
              <div className="font-serif-display text-[15px] tracking-wide text-[#2A2420]">
                SANVIC<span className="text-[#BA6A43]">.ph</span>
              </div>
              <div className="text-[10.5px] uppercase tracking-[0.18em] text-[#8A7E6E]">
                {showTala ? "Island Concierge" : "San Vicente, Palawan"}
              </div>
            </div>
          </div>
          <div className="flex items-center gap-2">
          ...
          <>
            <section className="px-6 pb-5">
              <div className="text-center">
                <div className="mx-auto mb-2 inline-flex items-center gap-1.5 rounded-full bg-[#F2ECDF] px-3 py-1 text-[10.5px] uppercase tracking-[0.2em] text-[#8A7E6E]">
                  <span className="h-1 w-1 rounded-full bg-[#BA6A43]" /> Your AI Island Assistant
                </div>
                <h1 className="font-serif-display text-[42px] leading-[1.02] text-[#2A2420]">
                  Hi, I'm <span className="italic text-[#BA6A43]">TALA</span>
                </h1>
            ...
            <section className="px-5 pb-6">
              <div className="relative flex flex-col items-center">
                ...
                <div className="mt-4 w-2/3">
                  <Waveform state={voiceState} onClick={handleMicTap} />
                </div>
                <button
            ...
            <section className="px-5 pb-6">
              <div className="mb-3 flex items-center justify-between">
                <span className="text-[11px] uppercase tracking-[0.22em] text-[#8A7E6E]">
                  Conversation
                </span>
                <button
                  onClick={() => setMessages(INITIAL_MESSAGES)}
                  className="text-[11px] text-[#8A7E6E]"
                >
                  Reset
                </button>
              </div>
              <div
                ref={scrollRef}
                className="no-scrollbar flex max-h-[360px] flex-col gap-3 overflow-y-auto pr-1"
              >
                {messages.map((m) => (
                  <MessageBubble
                    key={m.id}
              ...
              <div className="flex flex-col gap-3">
                {TALA_SUGGESTIONS.map((s) => (
                  <button
                    ...
                    onClick={() =>
                      s.soon
                        ? setToast("El Nido Luxury Shuttle — launching soon ✨")
                        : s.query && handleSuggestion(s.query)
                    }
                  ...
                  >
                    <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl bg-[#F2ECDF] text-[22px]">
                      {s.emoji}
                    </span>
                    <div className="min-w-0 flex-1">
                      <div className="font-serif-display text-[17px] leading-tight text-[#2A2420]">
                        {s.title}
                      </div>
            ...
            <section className="px-5 pb-6">
              ...
              <div className="flex flex-col">
                {ASKING_PROMPTS.map((p, i) => (
                  ...
                  >
                    <span className="font-serif-display text-[20px] leading-none text-[#BA6A43]/70">
                      “
                    </span>
            ...
            <section className="px-5 pb-4">
              <div className="flex items-center gap-2 rounded-[28px] bg-[#FFFDF8] p-2 shadow-card">
                <button
                  ...
                  className={`flex h-11 w-11 items-center justify-center rounded-full ${keyboardOpen ? "bg-[#2A2420] text-[#FAF5EB]" : "bg-[#F2ECDF] text-[#5A4F44]"}`}
                  aria-label="Keyboard"
                >
                ...
                {keyboardOpen ? (
                  <div className="flex flex-1 items-center gap-2 px-1">
                    <input
                      ...
                      className="flex-1 bg-transparent text-[14px] text-[#2A2420] placeholder:text-[#8A7E6E] focus:outline-none"
                    />
                    <button
                      onClick={() => sendMessage(input)}
                      className="flex h-9 w-9 items-center justify-center rounded-full bg-[#2A2420] text-[#FAF5EB]"
                    >
                  ...
                  <button
                    onClick={handleMicTap}
                    className="relative flex h-14 flex-1 items-center justify-center gap-2 rounded-full bg-[#2A2420] text-[#FAF5EB] shadow-soft"
                  >
                ...
                <button
                  onClick={() => {
                    const url =
                      "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=900&q=70";
                    appendMessage({ role: "user", kind: "image", image: url });
                    runQuery("Check out this photo", null, {
                      text: "Beautiful — looks like the north end of Long Beach around golden hour. Want me to pin it?",
                    });
                  }}
                  className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F2ECDF] text-[#5A4F44]"
                ...
                <button
                  onClick={() => {
                    const pin: LocationPin = {
                      ...
                      distance: "Alimanguan, San Vicente",
                      meta: "Shared just now with TALA",
                      category: "town",
                    };
                    appendMessage({ role: "user", kind: "location", location: pin });
                    runQuery("What is near me?", "food", {
                      text: "Three places within 1 km. Kuya Boy's is the top pick tonight — fresh tuna just off the boat.",
                      cards: [MOCK_BUSINESSES.food[0]],
                    });
                  }}
                  className="flex h-11 w-11 items-center justify-center rounded-full bg-[#F2ECDF] text-[#5A4F44]"
              ...
              <div className="mt-2.5 flex items-center justify-between">
                <button
                  onClick={() => setToast("Connecting you with a host…")}
                  className="flex items-center gap-2 rounded-full bg-[#F2ECDF] px-3 py-2 text-[12px] text-[#2A2420]"
                >
                  <Headphones className="h-3.5 w-3.5 text-[#435947]" /> Talk to a human host
                </button>
                <div className="flex items-center gap-1.5 text-[11px] text-[#8A7E6E]">
                  <span className="h-1 w-1 rounded-full bg-[#435947]" /> End-to-end encrypted
                </div>
              </div>
            </section>
          </>
            ...
            {[
              ...
              if (center) {
                return (
                  <button
                    key={key}
                    onClick={() => onNav(key as NavKey)}
                    className="relative -mt-8 flex flex-col items-center"
                  >
                    <span
                      className={`flex h-14 w-14 items-center justify-center rounded-full shadow-card ring-4 ring-[#FAF5EB] ${active ? "bg-[#2A2420] text-[#FAF5EB]" : "bg-[#D7CAAB] text-[#2A2420]"}`}
                    >
                      <Sparkles className="h-5 w-5" />
                    </span>
                    <span
                      className={`mt-1 text-[10.5px] ${active ? "font-semibold text-[#2A2420]" : "text-[#8A7E6E]"}`}
                    >
                      {label}
                    </span>
                  </button>
              ...
              return (
                ...
                >
                  <Icon
                    className={`h-[18px] w-[18px] ${active ? "text-[#BA6A43]" : "text-[#8A7E6E]"}`}
                  />
                  <span
                    className={`text-[10.5px] ${active ? "font-semibold text-[#2A2420]" : "text-[#8A7E6E]"}`}
                  >
                    {label}
                  </span>
                </button>
      ...
      {toast && (
        <div className="fade-up fixed bottom-24 left-1/2 z-[60] -translate-x-1/2 rounded-full bg-[#2A2420] px-4 py-2.5 text-[12.5px] text-[#FAF5EB] shadow-luxe">
          {toast}
        </div>
      )}
      <ReservationModal
